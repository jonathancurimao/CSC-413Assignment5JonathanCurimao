...
public class BankAccountTransactionTest { // this will test the Transaction interface and the execute commands
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer(1, "Jonathan","Curimao","jcurimao1@sfsu.edu", "123-456-789",new Address(415-789-223,"123 Main St.", "San Francisco", "San Mateo","94014","The United States"),0); // using the customer class to create a new account
